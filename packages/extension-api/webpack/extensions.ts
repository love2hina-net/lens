...
export default function generateExtensionTypes(): webpack.Configuration {
  return {
    ...
    output: {
      ...
      // e.g. require('@love2hina-net/k8slens.extensions')
    ...
    externals: [
      "@love2hina-net/k8slens.core/common",
      "@love2hina-net/k8slens.core/main",
      "@love2hina-net/k8slens.core/renderer",
    ],
    module: {
      rules: [
        {
        ...
        },
        {
          ...
          options: {
            ...
            // !! on '@love2hina-net/k8slens.extensions' module
            compilerOptions: {
