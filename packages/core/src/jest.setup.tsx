...
import type * as K8slensTooltip from "@love2hina-net/k8slens.tooltip";
...
jest.mock("@love2hina-net/k8slens.tooltip", () => ({
  ...jest.requireActual("@love2hina-net/k8slens.tooltip"),
