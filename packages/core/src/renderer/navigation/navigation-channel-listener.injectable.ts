...
import type { MessageChannel, MessageChannelListener } from "@love2hina-net/k8slens.messaging";
import { messageChannelListenerInjectionToken } from "@love2hina-net/k8slens.messaging";
