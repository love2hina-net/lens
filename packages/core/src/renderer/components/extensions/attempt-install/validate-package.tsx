 ...
 */
import { hasTypedProperty, isObject, isString, listTarEntries, readFileFromTar } from "@love2hina-net/k8slens.utilities";
import { manifestFilename } from "../../../../extensions/extension-discovery/extension-discovery";
import path from "path";
import type { LensExtensionManifest } from "@love2hina-net/k8slens.legacy-extensions";
