...
import type { ValidatingWebhookConfigurationData } from "@love2hina-net/k8slens.kube-object";
import { ValidatingWebhookConfiguration } from "@love2hina-net/k8slens.kube-object";
