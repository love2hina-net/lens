...
import type { PolicyIpBlock, NetworkPolicyPeer, NetworkPolicyPort, LabelMatchExpression, LabelSelector } from "@love2hina-net/k8slens.kube-object";
import { NetworkPolicy } from "@love2hina-net/k8slens.kube-object";
