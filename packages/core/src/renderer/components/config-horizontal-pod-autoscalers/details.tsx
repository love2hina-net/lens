...
import type { HorizontalPodAutoscalerMetricSpec, HorizontalPodAutoscalerMetricTarget } from "@love2hina-net/k8slens.kube-object";
import { HorizontalPodAutoscaler } from "@love2hina-net/k8slens.kube-object";
