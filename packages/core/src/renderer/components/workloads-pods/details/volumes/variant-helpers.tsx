...
import type { PodVolumeVariants, Pod, SecretReference, LocalObjectReference } from "@love2hina-net/k8slens.kube-object";
import type { KubeApiQueryParams, ResourceDescriptor } from "@love2hina-net/k8slens.kube-api";
