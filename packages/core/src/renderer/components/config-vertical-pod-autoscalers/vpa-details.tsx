...
import { ContainerScalingMode, ControlledValues, ResourceName, UpdateMode, VerticalPodAutoscaler } from "@love2hina-net/k8slens.kube-object";
import type { PodUpdatePolicy, PodResourcePolicy, VerticalPodAutoscalerStatus } from "@love2hina-net/k8slens.kube-object";
