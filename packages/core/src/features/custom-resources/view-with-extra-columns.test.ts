...
import type { KubeObjectMetadata, KubeObjectScope } from "@love2hina-net/k8slens.kube-object";
import { KubeObject, CustomResourceDefinition } from "@love2hina-net/k8slens.kube-object";
