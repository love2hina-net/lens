...
import type { GetSingleElement } from "@love2hina-net/k8slens.react-testing-library-discovery";
import { getSingleElement } from "@love2hina-net/k8slens.react-testing-library-discovery";
