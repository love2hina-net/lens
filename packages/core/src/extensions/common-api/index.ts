...
import { asLegacyGlobalForExtensionApi } from "@love2hina-net/k8slens.legacy-global-di";
...
export type { Logger } from "@love2hina-net/k8slens.logger";
export type { LensExtension } from "../lens-extension";
export type { PackageJson } from "type-fest";
export type { LensExtensionManifest, InstalledExtension } from "@love2hina-net/k8slens.legacy-extensions";
