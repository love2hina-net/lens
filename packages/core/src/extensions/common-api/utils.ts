...
import { asLegacyGlobalFunctionForExtensionApi, getLegacyGlobalDiForExtensionApi } from "@love2hina-net/k8slens.legacy-global-di";

export { Singleton } from "../../common/utils/singleton";

export {
  /**
   * @deprecated Switch to using the `@love2hina-net/k8slens.utilities` package
   */
  prevDefault,
  /**
   * @deprecated Switch to using the `@love2hina-net/k8slens.utilities` package
