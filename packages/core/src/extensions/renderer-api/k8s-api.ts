...
import { getLegacyGlobalDiForExtensionApi, asLegacyGlobalForExtensionApi, asLegacyGlobalFunctionForExtensionApi } from "@love2hina-net/k8slens.legacy-global-di";
import * as kubeApiSpecifics from "@love2hina-net/k8slens.kube-api-specifics";
