...
import type { ClusterFrameChildComponent } from "@love2hina-net/k8slens.react-application";
...
import { getEnvironmentSpecificLegacyGlobalDiForExtensionApi } from "@love2hina-net/k8slens.legacy-global-di";
