...
export const htmlTemplate = require.resolve("@love2hina-net/k8slens.core/template.html");
export const sassCommonVars = require.resolve("@love2hina-net/k8slens.core/vars.scss");
