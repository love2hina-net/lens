import { bundledExtensionInjectionToken } from "@love2hina-net/k8slens.legacy-extensions";
import { getInjectable } from "@ogre-tools/injectable";
import exampleBundledExtensionManifest from "@love2hina-net/k8slens.legacy-extension-example/package.json";
...
const exampleBundledExtensionInjectable = getInjectable({
  ...
  instantiate: (di) => ({
     ...
     */
    main: () => require("@love2hina-net/k8slens.legacy-extension-example/main").default,
    renderer: () => require("@love2hina-net/k8slens.legacy-extension-example/renderer").default,
  }),
